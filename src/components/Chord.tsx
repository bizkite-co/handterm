    ...
    return (
        <div className="chord-image-holder" id="chord-image-holder" data-source="ErrorDisplay.tsx">
            <div className="col-sm-2 row generated next" id="chord2">
                ...
                <img loading="lazy" alt="2" src={`${import.meta.env.BASE_URL}images/svgs/${foundChord?.chordCode}.svg`} height={CHORD_GLYPH_BASE.height * scale} width={CHORD_GLYPH_BASE.width * scale} className="hand"></img>
            </div>
        </div>
    );
};
