...
export const Achievements: Achievement[] = [
  ...
  { prompt: 'Type `jkl;`. Notice that it requires finger-grasp only.', phrase: 'jkl;'.split(''), unlocked: false, tutorialGroup: 'first-eight' },
  // { prompt: 'The second most important key is the Backspace key. To use it, pull back the index finger. Practice typing a character and then deleting it. Then press enter to continue.', phrase: ['DELETE (Backspace)'], command: 'x', unlocked: false, tutorialGroup: 'first-eight' },
  { prompt: 'Press the thumb tip followed by a finger tip to type numbers 0-4', phrase: '01234'.split(''), unlocked: false },
  { prompt: 'Press the thumb tip followed by a finger tip to type numbers 5-9', phrase: '56789'.split(''), unlocked: false, tutorialGroup: 'nums' },
